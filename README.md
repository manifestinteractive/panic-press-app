...
* __`www`__: Main Web Application
	* __`assets`__: Application Assets
		* __`css`__: Compile Project CSS Files
		* __`img`__: Folder for Images used in app
		* __`fonts`__: Collection of Fonts used in app
		* __`js`__: Compile Project JS Files
...
* __`test`__: A folder of unit tests. Each file will be executed when performing `npm test`
...
* __`karma.cong.js`__: Main Karma configuration file used when performing `npm test`
...
__Generated Content__ ( not apart of the git repository ):

* __`coverage`__: Code Coverage Report generated by running `npm test`

__Third Party Content__ ( not apart of the git repository ):
